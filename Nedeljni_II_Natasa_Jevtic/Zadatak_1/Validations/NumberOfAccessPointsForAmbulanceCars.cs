...
{
    class NumberOfAccessPointsForAmbulanceCarsValidation : ValidationRule
    {
        /// <summary>
        /// This method checks if user enter a number for access points and when editing number to be higher than previous number.
        /// </summary>
        ...
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            else
            {
                ...
                {
                    if (numberOfAccessPoints < this.Wrapper.OldNumberOfAmbulanceCars)
                    {
